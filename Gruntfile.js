module.exports = function(grunt) {
        ...
        sass: {
            dist: {
                ...
                files: {
                    ...
                    'src/fonts/fonts.css': 'src/fonts/fonts.scss'
                }
            }
        },
        ...
        cssmin: {
            ...
            combine: {
                files: [{
                    ...
                    'build/fonts.min.css': ['bower_components/normalize-css/normalize.css', 'src/fonts/fonts.css']
                }, {
                    ...
                    'individual_build/fonts.min.css': 'src/messages/fonts.css'
                }]
            }
        },
    ...
    grunt.registerTask('build', ['clean:build', 'concat:base', 'concat:grid', 'concat:buttons', 'concat:form', 'concat:tables', 'concat:menus', 'concat:messages', 'concat:fonts', 'concat:all', 'cssmin:combine']);
